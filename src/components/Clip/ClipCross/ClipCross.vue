  ...
  <div v-show="clipCross">
    <div class="sm-function-module-content">
      <div class="sm-function-module-sub-section">
        <label class="label-container">裁剪宽度(米) :</label>
      ...
      <div class="sm-function-module-sub-section">
        <label class="label-container">裁剪高度(米) :</label>
        <div class="sm-solider-input-box">
          <input
            class="min-solider"
            min="0"
      ...
      <div class="sm-function-module-sub-section">
        <label class="label-container">绕X轴旋转(度) :</label>
        <div class="sm-solider-input-box">
          <input
            class="min-solider"
            min="0"
      ...
      <div class="sm-function-module-sub-section">
        <label class="label-container">绕Y轴旋转(度) :</label>
        <div class="sm-solider-input-box">
          <input
            class="min-solider"
            max="360"
      ...
      <div class="sm-function-module-sub-section">
        <label class="label-container">绕Z轴旋转(度) :</label>
        <div class="sm-solider-input-box">
          <input
            class="min-solider"
            max="360"
      ...
      <div class="sm-function-module-sub-section">
        <label class="label-container">拉伸(米) :</label>
        <div class="sm-solider-input-box">
          <input
            class="min-solider"
            min="0"
...
export default {
  ...
  mounted() {
    if (this.isInitViewer && this.clipCross) {
      this.init();
    }
  },
