 ...
 */
define(['./when-8d13db60', './Check-70bec281', './Math-61ede240', './Cartographic-f2a06374', './Cartesian4-5af5bb24', './Cartesian2-16a61632', './BoundingSphere-356f49c6', './RuntimeError-ba10bc3e', './WebGLConstants-4c11ee5f', './ComponentDatatype-5862616f', './GeometryAttribute-1e248a71', './PrimitiveType-97893bc7', './FeatureDetection-7bd32c34', './Transforms-84e51c18', './buildModuleUrl-e7952659', './GeometryAttributes-aacecde6', './IndexDatatype-9435b55f', './IntersectionTests-d118a357', './Plane-29aa8f4d', './arrayFill-9766fb2e', './GeometryOffsetAttribute-999fc023', './VertexFormat-fe4db402', './arrayRemoveDuplicates-2869246d', './EllipsoidTangentPlane-be4d0295', './EllipsoidRhumbLine-87f26cac', './earcut-2.2.1-b404d9e6', './PolygonPipeline-01a00202', './PolylineVolumeGeometryLibrary-cc9b01a3', './EllipsoidGeodesic-9ef071e0', './PolylinePipeline-f937854b', './CorridorGeometryLibrary-589b3fde'], function (when, Check, _Math, Cartographic, Cartesian4, Cartesian2, BoundingSphere, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, FeatureDetection, Transforms, buildModuleUrl, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, arrayFill, GeometryOffsetAttribute, VertexFormat, arrayRemoveDuplicates, EllipsoidTangentPlane, EllipsoidRhumbLine, earcut2_2_1, PolygonPipeline, PolylineVolumeGeometryLibrary, EllipsoidGeodesic, PolylinePipeline, CorridorGeometryLibrary) { 'use strict';
        ...
        function computePositionsExtruded(params, vertexFormat) {
            ...
            if (when.defined(params.offsetAttribute)) {
                ...
                if (params.offsetAttribute === GeometryOffsetAttribute.GeometryOffsetAttribute.TOP) {
                    applyOffset = arrayFill.arrayFill(applyOffset, 1, 0, size); // top face
                    applyOffset = arrayFill.arrayFill(applyOffset, 1, size*2, size * 4); // top wall
                } else {
                    var applyOffsetValue = params.offsetAttribute === GeometryOffsetAttribute.GeometryOffsetAttribute.NONE ? 0 : 1;
                    applyOffset = arrayFill.arrayFill(applyOffset, applyOffsetValue);
                }
        ...
        CorridorGeometry.createGeometry = function(corridorGeometry) {
            ...
            if (extrude) {
                ...
                if (when.defined(corridorGeometry._offsetAttribute)) {
                    ...
                    arrayFill.arrayFill(applyOffset, applyOffsetValue);
