 ...
 */
define(['exports', './when-a55a8a4c', './Check-bc1d37d9', './Math-edfe2d1c', './Cartesian2-f0158650', './BoundingSphere-02d3af5e'], function (exports, when, Check, _Math, Cartesian2, BoundingSphere) { 'use strict';
    ...
    /**
        ...
        IntersectionTests.grazingAltitudeLocation = function(ray, ellipsoid) {
            ...
            if (!Cartesian2.Cartesian3.equals(position, Cartesian2.Cartesian3.ZERO)) {
                ...
                if (Cartesian2.Cartesian3.dot(direction, normal) >= 0.0) { // The location provided is the closest point in altitude
                    return position;
                }
            }
